  ...
  return (
      <>
        <div className={'members waver'}>
          ...
          <button data-bs-toggle="modal" data-bs-target="#addMember">Create new
            member
          </button>
        </div>
        <div className="modal fade" id="addMember" data-bs-backdrop="static"
             data-bs-keyboard="false"
             tabIndex="-1" aria-labelledby="addMemberLabel" aria-hidden="true">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="addMemberLabel">New member
                  form</h5>
                <button className={'btn-close mb-2'} id={'close-button-member'}
